...
**Linux / Mac**
```bash
curl -sSL https://raw.githubusercontent.com/EleshVaishnav/Parmana-2.0.git/main/install.sh | bash
```

**Windows (PowerShell)**
```powershell
iwr -useb https://raw.githubusercontent.com/EleshVaishnav/Parmana-2.0.git/main/install.bat -OutFile install.bat; .\install.bat
```
